    ...
    <section className="py-16 md:py-24 bg-[var(--card)]">
      <Container>
        ...
        <Carousel options={{ loop: true }}>
            {items.map((t, idx) => (
            <figure key={t.name} className="min-w-0 shrink-0 basis-full md:basis-[58%] lg:basis-[42%] rounded-[var(--radius)] border border-[var(--elev)] p-6 bg-[var(--card)]">
                 ...
                 {clients[idx % clients.length] ? (
                  <Image
                    ...
                    alt="logo"
                     width={480}
                     height={140}
                     sizes="(min-width:1280px) 420px, (min-width:768px) 360px, 260px"
