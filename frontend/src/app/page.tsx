                    ...
                    <Stack gap="md" style={{ height: '100%' }}>
                      ...
                      <Group justify="space-between" align="flex-start">
                        <Group gap="sm">
                          ...
                          <Stack gap={0}>
                            <Text fw={500} size="sm" style={{ fontWeight: 'var(--font-weight-medium)' }}>
                              {user.fullName}
                            </Text>
                            <Badge 
                              size="xs" 
          ...
          <Grid>
            <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
              <Stack gap="xs">
                ...
                <Text size="xs" fw={500} style={{ fontWeight: 'var(--font-weight-medium)' }}>علي جواد الربيعي</Text>
            ...
            <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
              <Stack gap="xs">
                ...
                <Text size="xs" fw={500} style={{ fontWeight: 'var(--font-weight-medium)' }}>أحمد محمد حسن</Text>
            ...
            <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
              <Stack gap="xs">
                ...
                <Text size="xs" fw={500} style={{ fontWeight: 'var(--font-weight-medium)' }}>فاطمة أحمد علي (+ 5 آخرين)</Text>
            ...
            <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
              <Stack gap="xs">
                ...
                <Text size="xs" fw={500} style={{ fontWeight: 'var(--font-weight-medium)' }}>محمد صالح أحمد (+ 3 آخرين)</Text>
            ...
            <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
              <Stack gap="xs">
                ...
                <Text size="xs" fw={500} style={{ fontWeight: 'var(--font-weight-medium)' }}>سارة عبد الله محمد (+ 4 آخرين)</Text>
