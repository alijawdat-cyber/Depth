...
### التحسينات المطبقة:
- ✅ **هامش الوكالة**: موحد ومفتوح بلا حدود
...
### نظرة عامة
تطبق منصة Depth نظام هامش وكالة **مفتوح بلا حدود** يحدده الأدمن من إعداد واحد مركزي، مما يضمن مرونة كاملة في التسعير وتحفيز الأداء حسب القيمة المضافة الفعلية.
...
```json
{
  "creatorExperienceLevels": {
    "fresh": {
      "agencyMarginPercent": "حسب القيمة المركزية الحالية",
      "description": "مبدعون جدد (أقل من 10 مشاريع)",
      "note": "يطبق عليهم الهامش المركزي الحالي في النظام"
    },
    "experienced": {
      "agencyMarginPercent": "حسب القيمة المركزية الحالية",
...
> **💰 الهامش المركزي:** قيمة رياضية واحدة مفتوحة بدون حدود تؤثر على كل الحسابات والأرباح في النظام.
...
```json
{
  "projectValueTiers": {
    "micro": {
      "range": "0-500,000 IQD",
      "agencyMarginPercentRange": "حسب القيمة المركزية الحالية",
...
### ملاحظات تطبيق API:
- **هامش الوكالة مفتوح بلا حدود** يحدده الأدمن من إعداد مركزي واحد
...
```json
{
  ...
  "agencyMargin": {
          "type": "central_unlimited",
          "isUnlimited": true,
          "description": "هامش مفتوح بدون حدود يحدده الأدمن",
          "currentRate": "يتم جلبه من الإعدادات المركزية",
          "retroactivePolicy": "لا يؤثر على المشاريع والفواتير المنجزة",
          "factors": [
          ...
          "description": "هامش مفتوح بلا حدود يحدده الأدمن من إعداد واحد - متوافق مع requirements v2.0"
        }
      }
    }
  }
...
```json
{
  ...
  "breakdown": [
    ...
    },
    {
      ...
      "total": 126500,
      "details": {
        "baseRange": "مفتوح بلا حدود",
        "defaultRate": "20%",
        "modifiers": "Expert creator (+5%), Repeat client (-2%)",
        "finalRate": "23%",
        "note": "قيمة مركزية واحدة مفتوحة بلا حدود"
      }
    }
  ],
  "subtotal": 688500,
      ...
      "byCreator": [
        {
          ...
          "agencyMargin": 737600,
          "agencyMarginPercentRange": "مفتوح بلا حدود",
