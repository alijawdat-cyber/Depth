...
الحالة: Deferred في V2.0. الدفع داخل النظام الآن يدوي عبر فاتورة/عقد واستلام نقدي أو تحويل. ذكر البوابات الإلكترونية محصور كفكرة مستقبلية للسوق العراقي فقط.

ملاحظة مستقبلية مختصرة: عند الحاجة، يمكن دراسة ربط بوابات دفع عراقية معتمدة (مثال: محافظ محلية/مصارف عراقية) في إصدار لاحق.
...
- [إدارة الملفات](../features/05-storage.md)
